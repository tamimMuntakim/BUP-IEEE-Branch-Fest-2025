...
const tiers = [
    {
        ...
        benefits: [
            "Company name and logo featured prominently as the Title Sponsor in the event program, digital materials, national media partner, and official proceedings",
            "Exclusive headline branding as '[Company Name] presents IEEE BranchFest 2025'",
            "Exclusive Job Fair presence with two stall spaces for product or service display",
            "Logo inclusion on IEEE vTools and across all official IEEE international submissions related to the event, providing international exposure for the company",
            "Sponsor recognition signage displayed in each event hall",
            "Certificate of Appreciation acknowledging generous contribution to IEEE BranchFest 2025",
            "Company logo featured on the official event website with an active external link",
            "Opportunity to include a flyer or promotional item in participant gift bags",
            "Platinum Sponsor Crest presented during the appreciation ceremony",
            "A C-level executive invited as a Keynote Speaker or Guest of Honor for a 10-minute address, with up to five executives serving as finale judges for selected competitions",
            "Exclusive early access to the CVs of all participants and priority interview opportunities for top performers",
            "Sponsorship Fee: 8,00,000/-",
        ],
    },
    {
        name: "Gold",
        ...
        description:
            "A prestigious sponsorship tier offering extensive branding, national exposure, and premium engagement opportunities.",
        benefits: [
            "Company name and logo featured prominently as the Gold Sponsor in the event program, digital materials, national media partner, and official proceedings",
            "Prominent secondary branding as 'Powered by [Company Name]' across all major platforms",
            "One stall space for Job Fair stall setup",
            "Logo featured on IEEE VTools and all official IEEE international submissions related to the event, ensuring international exposure",
            "Certificate of Appreciation acknowledging valuable support",
            "Opportunity to include a flyer or small promotional item in participant gift bags",
            "Gold Sponsor Crest presented during the appreciation ceremony",
            "Curated database of resumes from interested participants and IEEE members post-event",
            "Logo inclusion and a featured blog post on the event website",
            "Sponsorship Fee: 4,50,000/-",
        ],
    },
    {
        name: "Silver",
        ...
        description:
            "An official sponsorship tier designed for impactful visibility, meaningful participation, and professional engagement.",
        benefits: [
            "Recognized as an Official Silver Sponsor across event announcements and select promotional banners",
            "Featured with 'In association with' tag in select promotions and backdrops",
            "Booth space at the Job Fair to showcase company culture, career opportunities, and innovations",
            "Company logo placement on the official website, social media event pages, media partners, and shared sponsor backdrops",
            "Opportunity to nominate up to two company executives to serve as judges for preliminary competition rounds",
            "Silver Sponsor Crest presented during the appreciation ceremony",
            "Opportunity to include a flyer or promotional item in participant gift bags",
            "Sponsorship Fee: 1,00,000/-",
        ],
    },
];
