...
const PartnerWithUs = () => {
    return (
        <section id="partner-with-us" className="relative py-24 bg-gradient-to-b from-black via-gray-900 to-black text-white overflow-hidden">
            <div className="w-11/12 md:container mx-auto">
                ...
                <div className="text-center relative z-10">
                    ...
                    <h2 className="text-3xl sm:text-5xl md:text-6xl font-extrabold mb-2 bg-linear-to-r/hsl from-blue-600 to-teal-400 text-transparent bg-clip-text">
                        Partner With Us
                    </h2>
